...
public interface ApiService {
  ...
  @FormUrlEncoded
  @POST("marine.ashx")
  Call<com.worldweatheronline.domain.marine.Api> marine(@Field("q") String latLon);

  //  http://api.worldweatheronline.com/premium/v1/tz.ashx?key=API_KEY&q=Paris&format=json&includelocation=yes
  @FormUrlEncoded
  @POST("tz.ashx")
  Call<com.worldweatheronline.domain.timezone.Api> timezone(@Field("q") String location);
  ...
  Call<com.worldweatheronline.domain.weather.past.Api> pastWeather(
  ...
  Call<com.worldweatheronline.domain.marine.past.Api> pastMarineWeather(
